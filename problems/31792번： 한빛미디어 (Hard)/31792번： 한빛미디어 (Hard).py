...
#                                                                              #
#                                                       :::    :::    :::      #
#     Problem Number: 31792                            :+:    :+:      :+:     #
#                                                     +:+    +:+        +:+    #
#     By: magenta1223 <boj.kr/u/magenta1223>         +#+    +#+          +#+   #
#                                                   +#+      +#+        +#+    #
#     https://boj.kr/31792                         #+#        #+#      #+#     #
#     Solved: 2024-06-17 13:49:07 by magenta1223  ###          ###   ##.kr     #
#                                                                              #
#  **************************************************************************  #
...
Q = int(input()) ; S = SortedSet() ; V = [0] * 1000001
...
for _ in range(Q) :
    ...
    if a == 1 :
        ...
        if V[b] == 0 : continue
        V[b] -= 1
        if V[b] == 0 : S.discard(b)
    else :
        if len(S) == 0 : print(0) ; continue
        i = S[0] ; cnt = 1
        while True :
            idx = S.index_right(2*i-1)
            if idx == len(S) : break
            i = S[idx] ; cnt += 1
